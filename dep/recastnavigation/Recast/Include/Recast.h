...
/// Raised from upstream 13 to 16 to accommodate the vertical range of Legion-era
/// terrain (deep oceans + tall peaks in the same tile would overflow at 13 bits).
...
struct rcSpan
{
	...
	unsigned char area;                      ///< The area id assigned to the span. Full byte to cover all Legion area codes.
