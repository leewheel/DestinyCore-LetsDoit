...
// Note: tiles built with 32bit refs are not compatible with 64bit refs!
#define DT_POLYREF64 1

#ifdef DT_POLYREF64
#if defined(_WIN32) && !defined(__MINGW32__)
/// Custom typedef to keep MSVC happy on tile/poly ref types when 64-bit is enabled.
...
/// @ingroup detour
#ifdef DT_POLYREF64
// Layout tuned for WoW: many tiles per map, modest poly count per tile.
// 12-21-31 means 4096 salts, 2M tiles, 2B polys. Stays compatible with
// .mmtile files baked under the legacy fork.
