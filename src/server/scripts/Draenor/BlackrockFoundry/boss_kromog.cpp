    ...
    public:
        ...
        struct npc_foundry_grasping_earthAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_DISABLE_TURN);// | UnitFlags2::UNIT_FLAG2_UNK6 | UnitFlags2::UNIT_FLAG2_UNK11);
    ...
    public:
        ...
        struct npc_foundry_rune_of_crushing_earthAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_DISABLE_TURN);
        ...
        struct npc_foundry_reverberationAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
              //  me->DisableEvadeMode();
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
