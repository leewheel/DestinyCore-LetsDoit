    ...
    public:
        ...
        struct npc_foundry_flamebender_kagraz_triggerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE);
            }
    ...
    public:
        ...
        struct npc_foundry_lava_stalkerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE);
    ...
    public:
        ...
        struct npc_foundry_molten_torrent_stalkerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE);
