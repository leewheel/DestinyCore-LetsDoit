        ...
        struct boss_admiral_garanAI : public BossAI
        {
            ...
            void DamageTaken(Unit* p_Attacker, uint32& p_Damage) override
            {
                ...
                else if (p_Damage >= me->GetHealth())
                {
                    ...
                    /// From retail
                    me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_UNK_29);
                    me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_FEIGN_DEATH | UnitFlags2::UNIT_FLAG2_DISABLE_TURN);// | UnitFlags2::UNIT_FLAG2_UNK5);
                }
            }
               ...
               // UpdateOperations(p_Diff);
                ...
                switch (m_CustomEvent.ExecuteEvent())
                {
                    ...
                    case eEvents::EventDreadnaughtPhase:
                    {
                        ...
                        {
                            if (Creature* l_Chain = ObjectAccessor::GetCreature(*me, l_Guid))
                                l_Chain->SetFlag(UNIT_FIELD_FLAGS, UNIT_NPC_FLAG_SPELLCLICK);
                        }
    ...
    public:
        ...
        struct npc_foundry_loading_chainAI : public ScriptedAI
        {
            ...
            //    me->SetUInt32Value(UnitFields::UNIT_FIELD_INTERACT_SPELLID, eIronMaidensSpells::RideLoadingChain);
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
        ...
        struct npc_foundry_ukuroggAI : public ScriptedAI
        {
            ...
            void JustDied(Unit* /*p_Killer*/) override
            {
                ...
                if (GameObject* l_AmmoLoader = ObjectAccessor::GetGameObject(*me, m_Instance->GetGuidData(eFoundryGameObjects::AmmoLoader)))
                    l_AmmoLoader->RemoveFlag(GAMEOBJECT_FLAGS, GO_FLAG_NOT_SELECTABLE);
            }
    ...
    public:
        ...
        struct npc_foundry_iron_cannonAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
    ...
    public:
        ...
        struct npc_foundry_cluster_bomb_alphaAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
