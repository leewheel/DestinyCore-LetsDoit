...
struct auchindoun_kaathar_mob_nyami : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE);
    }
};
...
struct boss_kaathar : public BossAI
{
    ...
    void Reset() override
    {
        ...
        if (m_False)
        {
            ...
            me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE);
        }
            ...
            if (Creature* l_Tuulani = me->FindNearestCreature(CreatureSoulBinderTuulani, 1000.0f))
            {
                ...
                for (int8 l_I = 0; l_I < 3; l_I++)
                {
                    if (Creature* l_Prisoners = l_Tuulani->SummonCreature(eAuchindounCreatures::CreatureAucheniSoulPriest, g_PositionThreePrisoners[l_I], TempSummonType::TEMPSUMMON_DEAD_DESPAWN))
                    {
                       ...
                       // l_Prisoners->UNIT_NPC_EMOTESTATEUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                        l_Prisoners->SetFlag(UNIT_FIELD_FLAGS, UnitFlags2::UNIT_FLAG2_DISABLE_TURN);
                        l_Prisoners->SetFlag(OBJECT_DYNAMIC_FLAGS, UnitDynFlags::UNIT_DYNFLAG_DEAD);
                    }
                }
                ...
                for (int8 l_I = 0; l_I < 11; l_I++)
                {
                    if (Creature* l_Prisoners = l_Tuulani->SummonCreature(eAuchindounCreatures::CreatureAucheniDefender, g_PositionCorpsesNearNyomi[l_I], TempSummonType::TEMPSUMMON_DEAD_DESPAWN))
                    {
                        ...
                        l_Prisoners->AddUnitMovementFlag(MovementFlags::MOVEMENTFLAG_ROOT);
                        l_Prisoners->SetFlag(OBJECT_DYNAMIC_FLAGS, UnitDynFlags::UNIT_DYNFLAG_DEAD);
                        l_Prisoners->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                        l_Prisoners->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_DISABLE_TURN | UnitFlags2::UNIT_FLAG2_FEIGN_DEATH);
                    }
                }
                ...
                for (int8 l_I = 0; l_I < 4; l_I++)
                {
                    if (Creature* l_Defenders = l_Tuulani->SummonCreature(eAuchindounCreatures::CreatureAucheniWarden, g_PositionDefenderBehindMiddleWallOfNyami[l_I], TempSummonType::TEMPSUMMON_DEAD_DESPAWN))
                    {
                        ...
                        l_Defenders->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                ...
                for (int8 l_I = 0; l_I < 11; l_I++)
                {
                    if (Creature* l_Prisoner = l_Tuulani->SummonCreature(eAuchindounCreatures::CreatureAucheniDefender, g_PositionCorpsesNearNyomi[l_I], TempSummonType::TEMPSUMMON_DEAD_DESPAWN))
                    {
                        ...
                        l_Prisoner->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG2_DISABLE_TURN | UnitFlags2::UNIT_FLAG2_FEIGN_DEATH);
                    }
                }
...
struct auchindoun_kaathar_mob_hallowed_ground : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        if (!m_First)
        {
            ...
            me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE);
            me->SetReactState(ReactStates::REACT_PASSIVE);
        }
    }
...
struct auchindoun_kaathar_mob_spawn_fissures : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
    }
};
...
struct auchindoun_kaathar_mob_teleport_players : public ScriptedAI
{
    ...
    {
        me->SetReactState(ReactStates::REACT_PASSIVE);
        me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags2::UNIT_FLAG2_DISABLE_TURN);
        me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
    }
...
struct auchindoun_kaathar_mob_holy_shield : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UnitFlags::UNIT_FLAG_NOT_SELECTABLE | UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        /// Knockback
