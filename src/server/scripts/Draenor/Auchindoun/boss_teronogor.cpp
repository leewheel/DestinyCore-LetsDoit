...
struct boss_teronogor : public BossAI
{
    ...
    void DamageTaken(Unit* p_Attacker, uint32 &p_Damage) override
    {
        if(me->HealthWillBeBelowPctDamaged(75, p_Damage) && !m_SecondPhase)
        {
            ...
            me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_NON_ATTACKABLE);
        }
    }
    ...
    struct auchindoun_teronogor_mob_abyssalAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (m_First)
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | UnitFlags::UNIT_FLAG_IMMUNE_TO_PC | UnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
            }
        }
...
public:
    ...
    struct auchindoun_teronogor_mob_spiritAI : public ScriptedAI
    {
        ...
        {
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetFlag(UNIT_FIELD_FLAGS, UnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        }
    };
