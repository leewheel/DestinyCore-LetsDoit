    ...
    struct npc_instructor_chillheart_phylacteryAI : public Scripted_NoMovementAI
    {
        ...
        void JustDied(Unit* who)
        {
            if (InstanceScript* pInstance = me->GetInstanceScript())
                if (Creature* pChillheart = pInstance->GetCreature(DATA_INSTRUCTOR_CHILLHEART))
...
public:
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_ARCANE_BOMB:
                {
                    Position pos;
                    me->GetPosition();
                    pos.m_positionZ = me->GetMap()->GetHeight(me->GetPhaseShift(), pos.m_positionX, pos.m_positionY, pos.m_positionZ, true, 500.0f);
    ...
    private:
        ...
        bool GetRandomPos(Position& pos)
        {
            ...
            {
                pPhylactery->GetRandomNearPosition(30.0f);
...
public:
    ...
    class spell_instructor_chillheart_burn_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            Trinity::AnyUnfriendlyUnitInObjectRangeCheck u_check(GetCaster(), GetCaster(), 10.0f);
            Trinity::UnitListSearcher<Trinity::AnyUnfriendlyUnitInObjectRangeCheck> searcher(GetCaster(), newtargets, u_check);
            Cell::VisitAllObjects(GetCaster(), searcher, 10.0f, false);
        ...
        void Register()
        {
            OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_instructor_chillheart_burn_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_CASTER_AREA_ENEMY_FRONT);
        }
