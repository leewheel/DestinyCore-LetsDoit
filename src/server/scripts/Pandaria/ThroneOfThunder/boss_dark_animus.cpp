...
public:
    ...
    struct npc_crimson_wakeAI : public ScriptedAI
    {
        npc_crimson_wakeAI(Creature* creature) : ScriptedAI(creature)
        {
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_crimson_wakeAI(creature);
    }
};
...
public:
    ...
    {
        npc_anima_orbAI(Creature* creature) : ScriptedAI(creature)
        {
...
// 138373
class spell_powered_down : public SpellScriptLoader
{
public:
    spell_powered_down() : SpellScriptLoader("spell_powered_down") {}

    class spell_powered_down_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_powered_down_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_powered_down_AuraScript::HandleOnApply, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_powered_down_AuraScript::HandleOnRemove, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_powered_down_AuraScript();
    }
};

// 138400
class spell_critically_damaged : public SpellScriptLoader
{
public:
    spell_critically_damaged() : SpellScriptLoader("spell_critically_damaged") {}

    class spell_critically_damaged_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_critically_damaged_AuraScript);
        ...
        void Register()
        {
            OnEffectApply += AuraEffectApplyFn(spell_critically_damaged_AuraScript::HandleOnApply, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_critically_damaged_AuraScript();
    }
};
...
public:
    ...
    class spell_matter_swap_AuraScript : public AuraScript
    {
        ...
        void Register()
        {
            ...
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_matter_swap_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };
...
public:
    ...
    class spell_siphon_anima_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHitTarget += SpellEffectFn(spell_siphon_anima_SpellScript::OnHit, EFFECT_0, SPELL_EFFECT_POWER_DRAIN);
        }
    };
...
public:
    ...
    class spell_full_power_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_full_power_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_full_power_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    };

    AuraScript* GetAuraScript() const
    {
        return new spell_full_power_AuraScript();
    }
};
...
public:
    ...
    class spell_acceleration_link_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_acceleration_link_AuraScript);
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_acceleration_link_AuraScript::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
        }
    ...
    AuraScript* GetAuraScript() const
    {
        return new spell_acceleration_link_AuraScript();
    }
};
...
void AddSC_boss_dark_animus()
{
    ...
    new spell_critically_damaged;
    new spell_powered_down;
