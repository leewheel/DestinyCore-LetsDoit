...
class sb_npc_fiery_trickster : public CreatureScript
{
public:
    sb_npc_fiery_trickster() : CreatureScript("sb_npc_fiery_trickster") {}
    ...
    struct sb_npc_fiery_tricksterAI : public ScriptedAI
    {
        sb_npc_fiery_tricksterAI(Creature* creature) : ScriptedAI(creature)
        {
            me->SetUnitMovementFlags(MOVEMENTFLAG_DISABLE_GRAVITY);
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return new sb_npc_fiery_tricksterAI(creature);
    }
};
